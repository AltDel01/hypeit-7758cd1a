        ...
        <main className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-0 relative z-10">
          <div className="col-span-5 p-6">
            <div className="max-w-xl mx-auto">
              <h1 className="text-4xl mb-6 text-center leading-tight text-[#8c52ff] animate-gradient-text [text-shadow:_0_1px_0_rgb(0_0_0_/_40%)] md:[text-shadow:_0_1px_0_rgb(0_0_0_/_40%)]">
