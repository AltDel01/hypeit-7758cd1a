...
export const CATEGORY_MAP: Record<GenerationCategory, CategoryMeta> = {
  'image-gen': {
    ...
    requestType: 'image',
    provider: 'qwen',
    modelDefault: 'qwen-image',
    modelPro: 'qwen-image-plus',
    enabled: true,
    async: false,
    baseCredits: 50,
    proCredits: 80,
  ...
  'image-edit-instruction': {
    ...
    requestType: 'image',
    provider: 'qwen',
    modelDefault: 'qwen-image-edit',
    modelPro: 'qwen-image-edit',
    enabled: true,
    async: false,
    baseCredits: 80,
    proCredits: 80,
  ...
  'video-lipsync': {
    ...
    requestType: 'video',
    provider: 'wan',
    // Audio-driven lip sync runs through Wan 2.7 image-to-video with a
    // driving_audio track (emo-v1 / videoretalk are not hosted in this region).
    modelDefault: 'wan2.7-i2v',
    modelPro: 'wan2.7-i2v',
    enabled: true,
    async: true,
