          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between pt-3 md:pt-4 border-t border-gray-700/50 gap-3 md:gap-0">
            <div className="flex items-center gap-2 md:gap-3 overflow-x-auto scrollbar-hide">
              ...
              <DropdownMenu>
               ...
               filter(o => o.value !== '').     filter(o => o.value !== '').<Dropfilter(o => o.value !== '').downMenuItem key={option.value} onClick={() => setSelectedAspectRatio(option.value)} className={cn("flex items-center gap-3 cursor-pointer", selectedAspectRatio === option.value && "bg-purple-500/20")}>
             ...
             <span>{selectedResolution || 'Quality'}</span>
                ...
                <DropdownMenuContent align="start" className="bg-gray-800 border-gray-700">
                  {resolutionOptions.map((filtefilter(o => o.value !== '').r(o => o.value !== '').option) => (
