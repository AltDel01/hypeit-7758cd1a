...
const ImageDisplay = ({ images, generatedImage, showGenerated, aspectRatio }: ImageDisplayProps) => {
  ...
  // Create multiple copies of images for smoother looping - but not too many to avoid performance issues
  const displayImages = [...images, ...images, ...images, ...images];

  return (
    <div className="flex flex-col h-full overflow-hidden">
      <div className={`grid grid-cols-1 gap-5 ${animationClass} scrollbar-hide border-b-2 border-[#F2FCE2] flex-grow overflow-y-auto`}>
        ...
        {/* Display images for scrolling effect */}
