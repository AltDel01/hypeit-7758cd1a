...
const ContentGenerator = ({ 
  ...
  return (
    <div className="rounded-md border border-gray-700 p-4 bg-gray-900">
      <form onSubmit={handlePromptSubmit} className="mb-4">
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex justify-end">
            <Button type="submit" className="bg-[#9b87f5] hover:bg-[#8B5CF6] h-6 px-2 py-0.5 text-xs">
      ...
      {generatedImage && (
        <div className="mb-4 border border-[#9b87f5] rounded-md overflow-hidden">
          <div className="bg-[#9b87f5] px-2 py-1 text-white text-xs">
            Generated Image
          </div>
          <div className="p-2">
            <img 
