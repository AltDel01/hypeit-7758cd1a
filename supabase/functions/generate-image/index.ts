 ...
 */
async function handlePollingRequest(requestData: { requestId: string }) {
  ...
  try {
    ...
    if (responseText === "Accepted") {
      ...
      responseData = { 
        ...
        prompt, // Include prompt for fallback generation if needed
    ...
    console.error("Webhook or generation error:", error);
